...
void cls (void)
{
    rt_kprintf("\033[0;0H\033[J");
}

void draw_point(int x, int y, int c)
{
    rt_kprintf("\033[%d;%dH%c", y, x, c);
}
...
MSH_CMD_EXPORT(aclock, a terminal clock);
